...
| [Web server](https://en.wikipedia.org/wiki/Web_server){:target="_blank"} | Hosts web pages. A web server is what makes the World Wide Web possible. Each website has one or more web servers. | Computers with a web browser |
